...
export default function ProfilePage() {
  return (
    <main className="min-h-[100dvh] overflow-x-hidden bg-[linear-gradient(135deg,#f7f8ff_0%,#eef2ff_100%)] text-[#101426]">
      <DashboardHeader activeItem="none" />
      ...
      <div className="mx-auto w-full max-w-[1440px] px-5 py-7 sm:px-8 lg:px-12 lg:py-9 xl:px-16">
        <section className="rounded-[24px] border border-[#E4E7F0] bg-white p-6 shadow-[0_22px_70px_rgba(78,91,130,0.10)] sm:p-8">
          ...
          <p className="mt-3 max-w-[720px] text-base leading-7 text-slate-600">
            Manage learning preferences and study notices for the Socratic AI
            Tutor prototype.
          </p>

          <div
            id="study-notice"
            className="mt-6 rounded-[18px] border border-[#E4E7F0] bg-[#FBFCFF] p-5"
          >
            <h2 className="text-xl font-extrabold tracking-normal text-[#101426]">
              Study Notice
            </h2>
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Uploaded files stay in your browser in this prototype. Backend
              sync and account settings can be connected later.
            </p>
          </div>
...
export const metadata = {
  title: "Profile - Socratic AI Tutor",
};
